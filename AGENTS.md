...
- Recorded-file playback preview uses shared FFmpeg code on macOS and Windows to decode preview frames for the SWELL panel. Audio is heard only through REAPER.
